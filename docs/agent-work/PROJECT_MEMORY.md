...
- `content/IT Certificate Combined - Razi.pdf` has 20 certificate pages, rendered and optimized as individually attributed images in `public/certificates/`; the Certificates gallery lists title and issuer and links each image at full size.
